...
import com.example.bagmarket.ui.BazaarUi
...
fun IntroScreen() {
    ...
    Image(modifier = Modifier.fillMaxSize(), painter = painterResource(id = R.drawable.img_intro),
    ...
    Column (modifier= Modifier
        ...
        Button(modifier = Modifier.fillMaxWidth(0.7f), colors=ButtonDefaults.buttonColors(backgroundColor = Color.White),
